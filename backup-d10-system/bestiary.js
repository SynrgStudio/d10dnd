...
import {addD10Properties} from "./d10-converter.js";
...
class BestiaryPage extends ListPageMultiSource {
	...
	getListItem (mon, mI) {
		...
		// Agregar propiedades d10 al monstruo
		addD10Properties(mon);
	...
	_renderStatblock (mon, {isScaledCr = false, isScaledSpellSummon = false, isScaledClassSummon = false} = {}) {
		// Aplicar propiedades D10 al monstruo
		mon = addD10Properties(mon);
